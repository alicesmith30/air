(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        const menuLinks = document.querySelectorAll(".nav__list[data-goto]");
        ...
        const slValue = document.querySelector(".range__span");
        const inputSl = document.querySelector(".range__input");
        inputSl.oninput = () => {
            let value = inputSl.value;
